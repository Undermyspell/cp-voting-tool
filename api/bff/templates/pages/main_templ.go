...
func Hello(questions []voting_usecases.QuestionDto) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, item := range questions {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `bff/templates/pages/main.templ`, Line: 8, Col: 18}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `bff/templates/pages/main.templ`, Line: 8, Col: 37}
			}
...
func Main(title string, message string, questions []voting_usecases.QuestionDto) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `bff/templates/pages/main.templ`, Line: 92, Col: 15}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `bff/templates/pages/main.templ`, Line: 93, Col: 16}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var7))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</p><p>You are successfully authenticated and this page is served from a Go server!</p><img id=\"indicator\" class=\"htmx-indicator\" src=\"/static/spinner.gif\"> <button hx-get=\"/q/new\" hx-target=\"body\" hx-trigger=\"click\" hx-swap=\"beforeend\" class=\"bg-pink-600 p-4 border-4 border-blue-700\" type=\"button\">Add new Question Modal</button></div></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
